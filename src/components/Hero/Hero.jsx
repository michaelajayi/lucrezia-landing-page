...
import HeroImg from "../Assets/lucrezia-bg.png";
import Vector from "../Assets/lucrezia-logo.png";
...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className='block md:flex items-center justify-between px-4 justify-self-center'>
        <div>
